...
import { makeStyledComponentFromSvg } from "../transormers/styled-svg-to-rc"
...
import { ReactComponent as TestComponentSvg } from './testComponent.svg';
...
test("Test replace colors to variables", () => {
    const styledComponent = makeStyledComponentFromSvg(styledSvg, 'testComponent.svg', 'assets/components')
    expect(styledComponent).toEqual(component)
})